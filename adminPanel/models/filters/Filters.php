<?php
    ...
    /**
     * Class Filters
     * @package adminPanel\models\filters
     */
    class Filters extends BaseObject {
        ...
        static public function create(array $data) {
            ...
            try {
                ...
                if ($rusTableName && $latTableName && $titles) {
        ...
        public function getTitles($name) {
        ...
        static function getFilterName($in, $out) {
            try {
                $tableName[$out] = null;
                if ($out == 'latName') {
                    $tableName = (new Query())
        ...
        public function getBondedFilters($data) {
        ...
        public function saveBondedFilters(array $data) {
