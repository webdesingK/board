<?php
    ...
    $this->registerJsFile('@web/js/edit-filters.js', ['depends' => 'adminPanel\assets\AppAsset']);
    $this->registerCssFile('@web/css/edit-filters.css', ['depends' => 'adminPanel\assets\AppAsset']);
